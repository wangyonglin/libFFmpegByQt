...
libFFmpegByQt::CameraPlayer::CameraPlayer(QWidget *parent)
...
libFFmpegByQt::CameraPlayer::~CameraPlayer()
{


}
void libFFmpegByQt::CameraPlayer::play(const QString &url)
{
...
void libFFmpegByQt::CameraPlayer::pause()
{

}

void libFFmpegByQt::CameraPlayer::resume()
{

}

void libFFmpegByQt::CameraPlayer::stop()
{
    capture->stop();
...
void libFFmpegByQt::CameraPlayer::initializeGL()
{
...
void libFFmpegByQt::CameraPlayer::resizeGL(int w, int h)
{
    if(h<=0) h=1;
...
void libFFmpegByQt::CameraPlayer::paintGL()
{
    if(!ptr) return;
...
void libFFmpegByQt::CameraPlayer::rejectCallback(int err)
{
    emit reject(err);
}
